	...
	<body>
		<f:subview id="sr">
			...
			<rich:dataTable width="1300" var="record" value="">
				...
				<rich:column>
					<h:outputText value="9/9/2015 05:07:42 下午" />
				</rich:column>
				<rich:column>
				...
				<f:facet name="footer">
					...
					<rich:columnGroup>
						...
						<rich:column>
							<h:outputText value="9/10/2015 05:07:42 下午" />
						</rich:column>
						<rich:column>
							<h:outputText value="已成功执行" />
						</rich:column>
					...
					<td valign="top" style="">
						<table>
							...
							<tr>
								...
								<td>
									<rich:calendar value="9/10/2015 05:07:42 下午" id="calendar3" locale="en/US"
							...
							<tr>
								...
								<td>
									<rich:calendar value="9/10/2015 05:10:42 下午" id="calendar1" locale="en/US"
										popup="true" datePattern="d/M/yy HH:mm" showApplyButton=""
										cellWidth="24px" cellHeight="22px" style="width:200px"
										disabled="">
									</rich:calendar>
